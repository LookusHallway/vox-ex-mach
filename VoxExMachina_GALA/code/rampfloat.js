...
setinletassist(0, "float: low value (start of ramp)");
setinletassist(1, "float: high value (end of ramp)");
...
setoutletassist(0, "float: current ramped value");
...
function stepRamp() {
    ...
    var newValue = low + (high - low) * progress;
